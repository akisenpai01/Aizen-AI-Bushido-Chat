    ...
    <div className="sticky bottom-0 left-0 right-0 p-2 sm:p-4 bg-black/50 backdrop-blur-sm border-t border-border/50">
      <div className="flex items-end space-x-2">
        <Textarea
          ...
          className="flex-1 resize-none overflow-y-auto max-h-32 bg-background/70 text-foreground placeholder:text-muted-foreground focus-visible:ring-primary/50"
          rows={1}
