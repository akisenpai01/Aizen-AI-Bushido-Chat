...
const prompt = ai.definePrompt({
  ...
  - For any query that seeks factual information, details, current events, or specific knowledge (including technical topics like "computer software and engineering", or about places like "Dehradun" or "Italy"), you MUST use the internetSearchTool. If you believe you know the answer, use the tool to verify or supplement your knowledge. For mathematical questions, you MUST use the performMathematicalCalculationTool. Use the getTimeTool for time queries. 
